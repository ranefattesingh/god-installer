...
install_ripgrep() {
    ...
    case $yn in
        [Yy] )
            ...
            download_url="https://github.com/BurntSushi/ripgrep/releases/download/$latest_version/ripgrep_${latest_version}_amd64.deb"

            curl -LO "$download_url"
            sudo dpkg -i "ripgrep_${latest_version}_amd64.deb"
            rm -rf "ripgrep_${latest_version}_amd64.deb"
            ;;
    esac
}
